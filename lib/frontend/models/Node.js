...
export default class Node {
    ...
    constructor (node) {
        this.nodeId = node._nodeId || nodeCount
    ...
    registerMutationObserver (node) {
        const observer = new MutationObserver((mutations) => {
            ...
            attributeMutations.forEach(this.handleAttributeChange.bind(this))
            childListMutations.forEach(this.handleChildListMutations.bind(this))
            characterDataMutations.forEach(this.handleCharacterDataMutations.bind(this))
        })
